...
(8, 40, 25, 'nice', '2024-04-25 08:51:09');
...
(40, 'tomato soup', '\r\nRich, velvety tomato soup bursting with flavor from ripe tomatoes, onions, and garlic, simmered to perfection with a hint of basil and finished with a touch of cream.', 'Heat the olive oil in a large pot over medium heat. Add the onion and garlic, and cook until softened, about 5 minutes.\r\nAdd the crushed tomatoes, diced tomatoes, vegetable broth, sugar, dried basil, salt, and pepper. Bring to a boil, then reduce heat and simmer for 15-20 minutes.\r\nUse an immersion blender to blend the soup until smooth. Alternatively, carefully transfer the soup to a blender and blend until smooth, then return to the pot.\r\nStir in the heavy cream, if using, and heat through. Adjust seasoning if necessary.\r\nServe hot, garnished with fresh basil leaves.', 15, 1, 25, 1, '/ts.jpeg'),
(41, 'Custard', 'A Simple, easy to make Dessert. ', '1. Preheat your oven to 325°F (165°C) and place a large baking dish or roasting pan filled with about 1 inch of water in the oven to create a water bath for baking the custards.\r\n2. In a medium saucepan, heat the milk over medium heat until it\'s warm but not boiling.\r\n3. In a separate bowl, whisk together the sugar, eggs, vanilla extract, and salt until well combined.\r\n4. Slowly pour the warm milk into the egg mixture, whisking constantly.\r\n5. Strain the mixture through a fine-mesh sieve into a pouring jug to remove any lumps.\r\n6. Divide the custard mixture evenly among 4-6 ramekins or custard cups.\r\n7. Sprinkle a little ground nutmeg or cinnamon on top of each custard, if desired.\r\n8. Carefully place the ramekins in the water bath in the oven and bake for about 40-45 minutes, or until the custards are set around the edges but still slightly jiggly in the center.\r\n9. Remove the custards from the oven and let them cool to room temperature.\r\n10. Refrigerate the custards for at least 2 hours, or until they are well chilled and set.\r\nServe the custards cold, optionally garnished with fresh berries or a sprinkle of cinnamon.', 1, 2, 25, 4, '/custard.webp'),
(42, 'Milk shake', 'ytut', 'hfh\r\ngh\r\ngfh\r\ngfh', 20, 3, 25, 4, '/SWANAND SIGN.jpg');
...
(60, 40, 1, 1.00, 'Teaspoon'),
(61, 40, 19, 3.00, 'units'),
(62, 40, 97, 1.00, 'Teaspoon'),
(63, 41, 47, 1.00, 'units'),
(64, 41, 48, 2.00, 'units'),
(65, 41, 50, 3.00, 'units'),
(66, 41, 64, 3.00, 'cup'),
...
--
ALTER TABLE `req_ingredients`
  MODIFY `req_ingredient_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
