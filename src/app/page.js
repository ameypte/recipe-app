  ...
  return (
    ...
    >
      ...
      <div class="bg-white dark:bg-gray-900 py-16">
        ...
        {/* search bar */}
        <form class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
              <img class="rounded-t-lg" src="https://www.allrecipes.com/thmb/fFW1o307WSqFFYQ3-QXYVpnFj6E=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/48727-Mikes-homemade-pizza-DDMFS-beauty-4x3-BG-2974-a7a9842c14e34ca699f3b7d7143256cf.jpg" alt="" />
            </a>
            <div class="p-5">
              <a href="#">
